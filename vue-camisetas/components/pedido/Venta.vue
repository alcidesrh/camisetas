    ...
    <div class="pa-5">
        ...
        <v-card>
            <v-container style="position: fixed; z-index: 2001" fill-height justify-center
                         v-show="loading || retrieveLoadingPedido || retrieveLoadingTalla">
        ...
        <v-card>
            ...
            <div v-if="retrieved">
                ...
                >
                    <!--<v-card-title>-->
                        <!--<span class="">Datos de pedido:</span>-->
                    <!--</v-card-title>-->
                    <v-layout
                            tag="v-card-text"
                            text-xs-left
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                ...
                retrieveLoadingPedido: 'pedido/update/retrieveLoading',
        ...
        created() {
            this.$store.dispatch('pedido/update/reset');
